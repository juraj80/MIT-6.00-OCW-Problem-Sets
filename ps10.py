...
class Hand(object):
    ...
    def update(self, word):
        ...
        # TODO
        for letter in word:
            if letter in self.handDict.keys() and self.handDict[letter]>0:
    ...
    def containsLetters(self, letters):
        ...
        for letter in letters:
            if letter in self.handDict.keys():
                return True
            else:
                return False
    ...
    def isEmpty(self):
        ...
        # TODO
        count=0
        for value in self.handDict.values():
            count+=value
